...
return [
    ...
    */
    ...
    'job'                   => [
        ...
        'no_favourite_job_found'        => 'Trabalhos favoritos não disponíveis',
        'no_following_companies_found'  => 'Empresa a seguir não disponível',
        'no_followers_found'            => 'Nenhum seguidor encontrado',
        'no_applied_job_found'          => 'Trabalho aplicado não disponível',
        'remove_favourite_jobs'         => 'Remover empregos favoritos',
        'favourite_job_not_found'       => 'Empregos favoritos não encontrados',
        'favourite_companies_not_found' => 'Empresa favorita não encontrada',
        'applies_job_not_found'         => 'Trabalho aplicado não encontrado',
        'notes'                         => 'Notas',
    ],
