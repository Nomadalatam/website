            ...
            <div class="modal-body">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-sm-12">
                        ...
                        {!! Form::text('amount', null, ['id'=>'editAmount','class' => 'form-control amount', 'min' => '1', 'max' => '99999', 'readonly']) !!}
                        <span class="text-danger">{{ __('messages.plan.plan_amount_cannot_be_changes') }}</span>
                    </div>
                </div>
