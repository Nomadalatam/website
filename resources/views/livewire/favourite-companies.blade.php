                                ...
                                @foreach($favouriteCompanies as $favouriteCompany)
                                    <div class="col-12 col-sm-6 col-md-6 col-xl-4 favorite-job-details">
                                        <div class="hover-effect-favorite-company position-relative {{ $loop->odd ? 'blue-color' : 'black-color' }} mb-5">
                                            ...
                                            {{ (!empty($favouriteCompany->company->user->email)) ? $favouriteCompany->company->user->email : __('messages.common.n/a')}}</span>
                                                        </h3>
                                                        <h3 class="job-listing-title-favorite-company favourite-companies-margin">
                        ...
                        @else
                            ...
                            @else
                                <div class="col-lg-12 col-md-12 d-flex justify-content-center mt-4">
                                    <h5>{{ __('messages.job.favourite_companies_not_found') }} </h5>
                                </div>
                            @endif
                        @endif
                </div>
