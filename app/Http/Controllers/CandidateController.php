...
class CandidateController extends AppBaseController
{
    ...
    public function index(Request $request)
    {
        ...
        $jobsSkills = Skill::pluck('name', 'id')->toArray();

        return view('candidates.index', compact('statusArr', 'immediateAvailable', 'jobsSkills'));
    }
    ...
    public function resumes(Request $request)
    {
        if ($request->ajax()) {
            ...
            return Datatables::of((new ResumesDataTable())->get())->make(true);
        }
